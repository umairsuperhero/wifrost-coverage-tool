...
export default function Layout({ children }: LayoutProps) {
  return (
    <div className="flex flex-col h-screen overflow-hidden bg-black text-white relative">
      {/* Top Dynamic Island */}
      <header className="absolute top-6 left-1/2 -translate-x-1/2 flex items-center justify-between px-5 py-2.5 bg-white/5 backdrop-blur-3xl border border-white/10 rounded-full shadow-[0_8px_32px_rgba(0,0,0,0.4)] z-50 pointer-events-auto gap-8 sm:gap-16">
